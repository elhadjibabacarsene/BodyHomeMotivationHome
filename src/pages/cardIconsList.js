  ...
  return (
    <ul className="CardPaymentFormCardIcons">
      <li className={`${props.type === 'amex' && 'active'}`}>
        <Image fluid src={Imgamex} alt="Amex" width="35px" />
      </li>
      <li className={`${props.type === 'jcb' && 'active'}`}>
        <Image fluid src={Imgjcb} alt="JCB" width="35px" />
      </li>
      <li className={`${props.type === 'mastercard' && 'active'}`}>
        <Image fluid src={Imgmastercard} alt="MasterCard" width="35px" />
      </li>
      <li className={`${props.type === 'visa' && 'active'}`}>
        <Image fluid src={Imgvisa} alt="VISA" width="35px" />
      </li>
